...
public class ConfigState {
     ...
     * <p>
     * The approximation is vastly more efficient and increases successful bridge placements, but may break under strange circumstances (e.g. while using Tectonic or the Amplified world type).
     */
